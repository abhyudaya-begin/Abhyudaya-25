...
const SponsorSlider = () => {
  ...
  <h2 className="text-center text-5xl font-bold mb-8 bg-gradient-to-r from-purple-500 via-fuchsia-600 to-indigo-800 bg-clip-text text-transparent font-[Cinzel] tracking-wide">
  Our Sponsors
</h2>
